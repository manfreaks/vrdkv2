...
var sectionScrolls=[];$$('.content h2, .content h3').forEach(function(heading){sectionScrolls.push([heading.offsetTop,document.querySelector('#table-of-contents [href="#'+ heading.getAttribute('id')+'"]')]);});if(!sectionScrolls.length){return;}
